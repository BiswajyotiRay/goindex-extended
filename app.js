...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="https://cdn.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/js/mdui.min.js"></script>'
);
document.write(
  '<script src="https://cdn.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/js/flv.min.js"></script>'
);
document.write(
  '<script src="https://.jsdelivr.net/gh/BiswajyotiRay/goindex-extended@master/js/DPlayer.min.js"></script>'
);
document.write(
...
<script src="https://cdn.jsdelivr.net/gh/cheems/goindex-extended/js/ace.js"></script>
<script src="https://cdn.jsdelivr.net/gh/cheems/goindex-extended/js/ext-language_tools.js"></script>
	`;
  $("#content").html(content);
